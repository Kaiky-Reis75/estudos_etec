...
namespace atv_9
{
    class Program
    {
        ...
        {
            /* Esse programa é uma calculadora simples, onde o usuário pode escolher a operação matemática desejada, informar os números e obter o resultado da operação.
